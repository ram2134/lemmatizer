...
class TeluguData(LanguageSpecificData):
    '''Siva Reddy'''
    def __init__(self):
        # Devanagari script = \u0900-\u097f
        self.word = u"([\u0C00-\u0C7F\w])+"
...
Tokenize the FILES or standard input.
  ...
  -l, --language=LANG   language of the input
                        LANG is 'english', 'french', 'german', 'italian',
                                'spanish', 'dutch', 'czech', 'hindi',
                                or 'other' (defaults to 'english')
        ...
        try:
            if stream:
                ...
                try:
                    ...
                    udata = str(data, encoding, 'replace')
